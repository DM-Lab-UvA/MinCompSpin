...
void bind_search_mcm_class(py::module &m) {
    py::class_<PyMCMSearch>(m, "MCMSearch")
        ...
        .def("greedy_search", &PyMCMSearch::greedy_search, py::arg("Data"), py::arg("MCM") = nullptr, py::arg("file_name") = "")
        .def("divide_and_conquer", &PyMCMSearch::divide_and_conquer, py::arg("Data"), py::arg("MCM") = nullptr, py::arg("file_name") = "")
        .def("simulated_annealing", &PyMCMSearch::simulated_annealing, py::arg("Data"), py::arg("MCM") = nullptr, py::arg("file_name") = "")
